...
import (
	...
	"github.com/sonicwall-kubernetes/sonicwall-network-policy/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type K8sV1alpha1Interface interface {
	RESTClient() rest.Interface
	SonicwallNetworkPoliciesGetter
}

// K8sV1alpha1Client is used to interact with features provided by the k8s.sonicwall.com group.
type K8sV1alpha1Client struct {
	restClient rest.Interface
}

func (c *K8sV1alpha1Client) SonicwallNetworkPolicies(namespace string) SonicwallNetworkPolicyInterface {
	return newSonicwallNetworkPolicies(c, namespace)
}
